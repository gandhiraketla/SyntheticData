...
def _process_dataset(output_directory, num_classes, coder, name, num_images,
  ...
  """
  print('Inside _process_dataset')                   
  files_per_shard = num_images // num_shards
  print('files_per_shard') 
  print(files_per_shard)
  print(num_shards)
...
def write_black_and_white_tfrecord_data(
    ...
    num_validation_images=128, train_shards=100, validation_shards=2):
  ...
  """
  #output_directory='/Users/gandhira/Documents/ML-Lab/syndata/'
  coder = ImageCoder()
  print('coder')
...
if __name__ == '__main__':
    print('Generating')
    print(sys.argv[1])
    write_black_and_white_tfrecord_data(sys.argv[1],2,512,128,int(sys.argv[2]),int(sys.argv[3]))